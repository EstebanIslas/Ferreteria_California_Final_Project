...
<body>
	...
	if (!isset($_SESSION["usuario"])) {
		header("location:index.html");# code...
	}
	...
	<?php 
	 ...
	 ?>
	 <a href="cerrar_session.php" class="btn orange">Cerrar sesion</a>

	 


	<img src="logo_cali.png">
		...
		<table border="1px" cellpadding="5px" width="100%">
			<thead class="cartHeader" display="off">
				...
				<tr>
					...
					<th colspan="3">Productos: <?=$cart->get_total_items();?></th>
				</tr>
			</thead>
